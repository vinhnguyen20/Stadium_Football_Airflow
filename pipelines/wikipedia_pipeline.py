...
def get_lat_long(country, city):
    geolocator = Nominatim(user_agent='VinhNguyen20app', timeout=10)
...
def transform_wikipedia_data_ep1(**kwargs):
...
def write_wikipedia_data(**kwargs):
    ...
    import sqlite3
    data = kwargs['ti'].xcom_pull(key='rows', task_ids='transform_wikipedia_data_ep1')
